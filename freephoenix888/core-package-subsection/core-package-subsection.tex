...
\paragraph*{String}\hypertarget{Core.String.Description}{}
...
\paragraph*{Query}\hypertarget{Core.Query.Description}{}
Query нужен для того, что бы запрашивать связи на отображение на экране
\newcommand{\QueryByUsingContextMenu}{%
...
\newcommand{\QueryByUsingClientHandler}{%
      ...
      \begin{itemize}
            ...
            \item Введите следующий запрос в появившееся поле для ввода: \input{../core-package-subsection/query-core-package-listing.tex}
            \item Нажмите на лампочку справа от поля для ввода
            \item Созерцайте пакет @deep-foundation/core
      \end{itemize}%
}
\newcommand{\QueryByUsingLinks}{%
      ...
      \begin{itemize}
            ...
            \item \hyperlink{DeepCase.UpdatetLink.Description}{Обновить}
                  значение связь myQuery на \input{../core-package-subsection/query-core-package-listing.tex}
            \item \hyperlink{DeepCase.InsertLink.Description}{Вставьте}
