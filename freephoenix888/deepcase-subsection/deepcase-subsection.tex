...
\newcommand{\DeepCaseQueryByUsingClientHandler}{%
      ...
      \begin{itemize}
            ...
            \item Введите следующий запрос в появившееся поле для ввода: \input{../deepcase-subsection/query-core-package-listing.tex}
...
\newcommand{\DeepCaseQueryByUsingLinks}{%
      ...
      \begin{itemize}
            ...
            \item \hyperlink{DeepCase.UpdatetLink.Description}{Обновить}
                  значение связь myQuery на \input{../deepcase-subsection/query-core-package-listing.tex}
            \item \hyperlink{DeepCase.InsertLink.Description}{Вставьте}
