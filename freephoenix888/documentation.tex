...
%       \end{itemize}%
% }
% \newcommand{\DeepCaseQueryByUsingClientHandlerQueryCode}{%
%                   \begin{lstlisting}
%             {
%                   id: {
...
%       \begin{itemize}
%             \item \hyperlink{DeepCase.InsertLink.Description}{Вставить} связь типа
...
%       \begin{itemize}
%             \item \hyperlink{DeepCase.InsertLink.Description}{Вставить}
...
%                   \DeepCaseQueryByUsingLinksQueryCode
%             \item \hyperlink{DeepCase.InsertLink.Description}{Вставить}
