...
Создаём \texttt{Handler} (от: \hyperlink{dockerSupportsJs.def}{dockerSupportsJs}, до: наш \texttt{SyncTextFile})
...
\end{lstlisting}
  \item Создаём \texttt{Handler} (от: \hyperlink{dockerSupportsJs.def}{dockerSupportsJs} , до: наш \texttt{SyncTextFile})
...
\end{lstlisting}
  \item Создать Handler от \hyperlink{dockerSupportsJs.def}{dockerSupportsJs} до нашего SyncTextFile
  \item Создать Route
