...
\newcommand{\HowToSeeAsyncHandlerResult}{
    Что бы увидеть результат выполнения обработчика -
    откройте контекстное меню связи, нажмите Traveller, затем затем Down, затем
...
\begin{itemize}
  ...
  \item \HowToSeeAsyncHandlerResult
\end{itemize}
