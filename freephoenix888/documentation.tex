...
\begin{itemize}
  ...
  \item \hyperlink{DeepCase.InsertLink.Description}{Вставьте} связь типа
        \hyperlink{Core.Handler.Description}{Handler} с началом
        \hyperlink{Core.plv8SupportsJs.Description}{dockerSupportsJs} и
        концом
...
\begin{itemize}
  ...
  \item \hyperlink{DeepCase.InsertLink.Description}{Вставьте} связь типа
        \hyperlink{Core.Handler.Description}{Handler} с началом
        \hyperlink{Core.dockerSupportsJs.Description}{dockerSupportsJs} и
        концом
        myHandlerCode \hyperlink{FAQ.HowToSetName}{назовите} её myHandler
  \item \hyperlink{DeepCase.InsertLink.Description}{Вставьте} связь типа
        Email и \hyperlink{FAQ.HowToSetName}{назовите} её email
...
\end{lstlisting}
  ...
  \item \hyperlink{DeepCase.InsertLink.Description}{Вставьте} связь типа
        \hyperlink{Core.HandlePort.Description}{HandlePort} с началом
        myPort и концом
