...
Создаём \texttt{Handler} (от: \texttt{dockerSupportsJs}, до: наш \texttt{SyncTextFile})
...
\end{lstlisting}
  \item Создаём \texttt{Handler} (от: \texttt{dockerSupportsJs} , до: наш \texttt{SyncTextFile})
