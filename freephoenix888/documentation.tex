...
\begin{enumerate}
  ...
  \item \textbf{Связи-типы:}
        \begin{itemize}
          ...
          \item Если связь ведёт от определённой связи к другой связи, то
                началом
                и концом экземпляра связи должны быть связи определённого типа
...
Если связь является точкой (без начала и конца) - вы сможете вставить связь
такого типа как точку
