...
\begin{itemize}
  ...
  \item Открываем контекстное меню экземпляра Space и нажимаем кнопку "Space" что бы перейти в этот Space
  ...
  \item Открываем контекстное меню, нажимаем кнопку Traveller, нажимаем кнопку Down, нажимаем на кнопку myTree
  \item Созерцайте путешествие от связи myNode1 вниз по дереву myTree, вы должны видеть связи myNode1, myDownLink, myNode2
  \item Открываем меню DeepCase, нажимаем крестик около слова space, что бы выйти из текущего space и вернуться в space нашего пользователя
  \item Снова создаём новый space, заходим в него
  \item Снова с помощью Query запрашиваем связь, но уже myNode2
  \item С помощью Traveller запрашиваем связи вверх по дереву myTree
  \item Видим связи myNode2, myDownLink, myNode1
  \item Возвращаемся в предыдущий Space
\end{itemize}
