...
\subsubsection{Описание}
@deep-foundation/core\hypertarget{core.Description}{} это встроенный пакет, которые
содержит самые важные типы для работы с Deep
\subsubsection{Связи}
\paragraph*{Type}
Тип Type\hypertarget{Core.Type.Description}{} используется для создания новых типов
\paragraph*{Contain}
Тип Contain\hypertarget{Core.Contain.Description}{} используется для обозначения
...
Тип SyncTextFile\hypertarget{Core.SyncTextFile.Description}{} используется для хранения
любого строкового значения
\paragraph*{Any}
Тип Any\hypertarget{Core.Any.Description}{} может использоваться для ограничений
...
\paragraph*{Handler}
Тип Handler\hypertarget{Core.Handler.Description}{} используется для создания обработчика.
...
\paragraph*{Supports}
Тип Supports\hypertarget{Core.Handler.Description}{} используется для создания среды
выполнения обработчика. Примером среды выполнения обработчика является
\hyperlink{Core.dockerSupportsJs.Description}{dockerSupportsJs}
\paragraph*{dockerSupportsJs}
Связь dockerSupportsJs\hypertarget{Core.dockerSupportsJs.Description}{} используется для
...
Связь HandleInsert\hypertarget{Core.HandleInsert.Description}{} используется для обработки
...
Связь HandleUpdate\hypertarget{Core.HandleUpdate.Description}{} используется для обработки
...
\paragraph*{HandleUpdate}
Связь HandleDelete\hypertarget{Core.HandleDelete.Description}{} используется для обработки
...
экземпляром \hyperlink{Core.Handler.Description}{Handler}
\paragraph*{Tree}
Тип Tree\hypertarget{Core.Tree.Description}{} используется для создания дерева
\paragraph*{TreeIncludeDown}
Тип TreeIncludeDown\hypertarget{Core.TreeIncludeDown.Description}{} используется для
включения в дерево связи, по направлению вниз
\paragraph*{TreeIncludeUp}
Тип TreeIncludeUp\hypertarget{Core.TreeIncludeUp.Description}{} используется для включения в
дерево связи, по направлению вверх
\paragraph*{TreeIncludeNode}
Тип TreeIncludeNode\hypertarget{Core.TreeIncludeNode.Description}{} используется для
включения в дерево связи, у которой нет начала и конца
\paragraph*{Route}
Тип Route\hypertarget{Core.Route.Description}{} используется для создания веб-маршрута
\paragraph*{HandleRoute}
Связь HandleRoute\hypertarget{Core.HandleRoute.Description}{} используется для обработки
веб-маршрута

\paragraph*{Router}
Тип Router\hypertarget{Core.Router.Description}{} используется для создания роутера
\paragraph*{RouterStringUse}
Связь RouterStringUse\hypertarget{Core.RouterStringUse.Description}{} используется для
указания веб-маршрута, который должен обрабатываться
\paragraph*{Port}
Тип Port\hypertarget{Core.Port.Description}{} используется для создания порта
\paragraph*{RouterListening}
Связь RouterListening\hypertarget{Core.RouterListening.Description}{} используется для
указания порта, который должен обрабатываться
\paragraph*{Space}
Тип Space\hypertarget{Core.Space.Description}{} используется для создания пространства
