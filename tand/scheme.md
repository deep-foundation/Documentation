...
#### GIT
в git есть несколько основных понятий. база данных, конфиг, ветки, файлы, изменения файлов, коммиты, пуши и тд. подробнее об использовании git можете прочесть [здесь](git.md)
