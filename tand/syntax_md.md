...
документация сделана так, что бы работать в obsidian, github, discord и deep-case(на данный момент проводятся тесты) одновременно для удобства написания. работать мы будем с md файлами, которые расшифровываются как [markdown](scheme.md#MARKDOWN) файлы
...
#### ТЕГИ
нужны для удобного поиска статей по категориям. совместимы не со всеми источниками распространения, однако все ещё способны выполнять свою функцию в частично виде. пишутся сразу после заголовков или подзаголовков, вначале пишете '#' а после сразу же название тега, следующий блок пишется с красной строки
